                    ...
                    <div className="w-full">
                        ...
                        <div className="px-5">
                            ...
                            <div className="grid grid-cols-2">
                                <div>
                                    <p className="text-md"><b>RNC:</b> 132-38173-4</p>
                                    <p className="text-md"><b>FECHA:</b> {dayjs(invoice.createdAt).format("DD/MM/YYYY")}</p>
                                </div>
                                <div className="text-right">
                                    <p className="text-md"><b>NCF:</b> {invoice.ncfNumber}</p>
                                    <p className="text-md"><b>VENCIMIENTO:</b> {dayjs(invoice.expirationDate).format("DD/MM/YYYY")}</p>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-2">
                                    <div>
                                        <p className="text-md"><b>{invoice.clientName}</b></p>
                                        <p className="text-md"><b>RNC:</b> {invoice.clientRnc}</p>
                                    </div>
                                    <div className="text-right">
                                        <p className="text-md"><b>CONDICIONES:</b> {invoice.paymentCondition}</p>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <table className="w-full table-auto">
                                        ...
                                        <tbody>
                                            ...
                                            <tr className="font-bold">
                                                ...
                                                <td className="text-right py-4">{itbis.toFixed(2)}</td>
                                            </tr>
                                            <tr className="font-bold">
                                                <td></td>
                                                <td></td>
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-md font-medium text-black mb-8">Garantía para articulos pequeños corresponde a 15 dias habiles. Los audífonos (todos los modelos ) cuentan con una garantía de 24 a 48 horas. No se aceptan devoluciones de mercancía sucia, alterada, dañada, y/o en oferta.</p>
                                <p className="text-md font-medium text-black mb-8">Para mayor información sobre las garantías, por favor ponerse en contacto con nosotros a través de los diferentes medios de contacto.</p>
                            </div>
                        </div>
                    </div>
                </div>
